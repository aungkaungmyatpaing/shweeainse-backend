...
<html lang="en" data-layout="vertical" data-topbar="light" data-sidebar="dark" data-sidebar-size="lg">
    ...
    <body>
           ...
           <div class="auth-page-wrapper auth-bg-cover py-5 d-flex justify-content-center align-items-center min-vh-100">
            <div class="bg-overlay" style="background:#FFA9AA"></div>
            <!-- auth-page content -->
                                            ...
                                            <div class="position-relative h-100 d-flex flex-column justify-content-center align-items-center    ">
                                                <div class="mb-4">
                                                    <a href="#" class="d-block">
                                                        <img src="{{ asset(config('app.companyInfo.logo_white')) }}" class="" alt="" style="height: 250px;">
                                                    </a>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="p-lg-5 p-4">
                                            ...
                                            <div class="mt-4">
                                                <form action="{{ route('postLogin') }}" method="POST">
                                                    ...
                                                    <div class="mt-4">
                                                        <button class="btn btn-success w-100 border-0" style="background: #FFA9AA" type="submit">Sign In</button>
                                                    </div>
                                                </form>
                                            </div>
