    ...
    <div class="col-xl-10 offset-xl-1">
        <div class="card my_card">
            <div class="card-header bg-transparent">
                <a href="{{route('brand')}}" class="card-title mb-0 d-inline-flex align-items-center create_title">
                    <i class=" ri-arrow-left-s-line mr-3 primary-icon"></i>
                    <span class="create_sub_title">{{$brand->name}} ကိုပြုပြင်မည်</span>
                </a>
            </div><!-- end card header -->
            <div class="card-body">
                <div class="row d-flex justify-content-center">
                    <div class="col-xl-9">
                        <form method="POST" action="{{route('brand.update', $brand->id)}}" id="brand_update" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="upload mb-3">
                                <div class="preview_img">
                                    @if ($brand->image)
                                        <img src="{{$brand->image}}" alt="" width=150 height=150 alt="">
                                    @endif
                                </div>
                                <div class="round">
...
@section('script')
    {!! JsValidator::formRequest('App\Http\Requests\StoreBrandRequest', '#brand_update') !!}
    <script>
