            ...
            <div class="card-header bg-transparent">
                <div class="d-flex align-items-center justify-content-between">
                    ...
                    <div class="d-flex gap-2">
                        @if (!($order['status'] == 'cancel' || $order['refund_date']))
                    ...
                    @if ($order['status'] == 'processing')
                        <a class="primary_button" href="{{ route('order.deliver',$order['id']) }}" data-status="delivered">
                            <div class="d-flex align-items-center">
                                <i class=" ri-checkbox-circle-fill mr-2 primary-icon"></i>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="" style="width:100px">
                                            <a href="{{ $order['refund_screenshot'] }}" class="d-flex flex-column" data-lightbox="deliveredPhoto" data-title="">
                                                <img src="{{ $order['refund_screenshot'] }}" class="rounded"  alt="" srcset="" style="width: 150px;">
                                            </a>
                                        </div>
                                    </td>
                                </tr>
