...
@section('content')
    ...
    <div class="card-header d-flex justify-content-between align-items-center bg-transparent">
        <h5 class="mb-0 text-dark">Regions - <div class="badge badge-myColor" id="badgeTotalCount">{{ App\Models\Region::count() }}</div></h5>
      ...
      $(document).ready(function() {
            let table = $('#datatable').DataTable( {
                ...
                columns : [
                  ...
                  {data: 'cod', name: 'cod' , class: 'text-center'},
