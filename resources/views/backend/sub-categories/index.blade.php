...
<div class="card my_card">
        <div class="card-header d-flex justify-content-between align-items-center bg-transparent">
            <h5 class="mb-0 text-dark">Catgories - <div class="badge badge-myColor" id="badgeTotalCount">{{ App\Models\SubCategory::count() }}</div></h5>
            ...
            <div class="table-responsive">
                <table class="table" id="datatable" style="width:100%;">
                    <thead class="text-center bg-light text-muted">
                        ...
                        <th class="text-center no-sort">Category အမည်</th>
    ...
    <script>
      $(document).ready(function() {
            let table = $('#datatable').DataTable( {
                ...
                serverSide: true,
                responsive: true,
                ajax: "/subcategories/datatable/ssd",
                language : {
                ...
                columnDefs : [
                  ...
                  {
                    targets : [0, 2, 3, 4], // Indexes of columns other than 'name'
                    searchable : false,
                  },
                  {
                    targets : 'no-search',
