                                ...
                                @if (count($unreadNoti) != 0)
                                    ...
                                    <div class="text-reset notification-item d-block dropdown-item position-relative">
                                        <div class="d-flex">
                                            ...
                                            <div class="">
                                                <a href="{{ route('noti.delete',$noti->id) }}" class="btn noti_close_btn shadow-sm  p-1 py-1 d-flex justify-content-center align-items-center" style="width: 30px;height:30px"><i class=" ri-close-fill"></i></a>
                                            </div>
                                        </div>
                                    </div>
